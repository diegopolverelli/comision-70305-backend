...
let nombres = ['Lautaro', 'Martina', 'Jimena', 'Morena', 'Marcos', 'Luca', 'Diego', 'Isabella', 'Juana', 'Carolina', 'Fernando', 'Federico', 'Gonzalo', 'Veronica', 'Catalina', 'Sergio', 'Rodrigo', 'Luis']
...
let estudios = ['literatura', 'medicina', 'desarrollo web', 'desarrollo backend', 'idiomas', 'rrhh', 'administracion de empresas', 'profesorado', 'ingenieria civil', 'abogacia', 'fisica', 'tecnicatura en ciencias de la comunicacion', 'finanzas', 'economia', 'ciencias politicas']
let pais_de_origen = ['Argentina', 'Venezuela', 'Mexico', 'Uruguay', 'Nicaragua', 'Chile', 'Colombia', 'Costa Rica']
